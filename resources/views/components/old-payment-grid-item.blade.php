...
<a href="{{route('oldpay.show',['id'=>$payment->id])}}" class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-103 ">
    <div class="xyzpayment flex flex-col items-center justify-center bg-white p-4 shadow rounded-lg">
        ...
        <div class="w-full pt-16">
            <div class="flex flex-row justify-center items-center">
                {{--TRANS--}}
                <div class="transaction flex items-center justify-start p-2 text-purple-500">
                ...
                {{--/TRANS--}}
                {{--ORDER--}}
                <div class="order flex items-center justify-start p-2 text-purple-500">
                    <div class="transaction-logo mr-2">
                ...
                {{--/ORDER--}}
                {{--AGO--}}
                <div class="date flex items-center justify-start p-2 text-purple-500">
