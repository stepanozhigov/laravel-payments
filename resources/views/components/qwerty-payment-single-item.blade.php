<div class="xyzpayment flex flex-col items-center justify-center bg-white p-4 shadow rounded-lg">
    ...
    <div class="w-full pt-16">
        <div class="flex flex-row justify-between items-center">
            {{--TRANS--}}
            <div class="relative transaction flex items-center justify-start p-2 text-blue-500 w-full">
                ...
                <div class="absolute text-center opacity-0 hover:opacity-100 inset-0 bg-gray-800 text-black bg-blue-500 text-white flex items-center justify-center font-medium cursor-pointer">Payment ID</div>
            </div>
            {{--/TRANS--}}
            {{--ORDER--}}
            <div class="relative order flex items-center justify-start p-2 text-blue-500 w-full">
                <div class="transaction-logo mr-2">
                    <i class="fi-xnluxl-shopping-cart text-2xl"></i>
                </div>
                <p class="font-normal text-sm leading-none">#{{$payment->order_id}}</p>
                <div class="absolute text-center opacity-0 hover:opacity-100 inset-0 bg-gray-800 text-black bg-blue-500 text-white flex items-center justify-center font-medium cursor-pointer">Order ID</div>
            </div>
            {{--/ORDER--}}
            {{--AGO--}}
            <div class="relative date flex items-center justify-start p-2 text-blue-500 w-full">
                ...
                <div class="absolute text-center opacity-0 hover:opacity-100 inset-0 bg-gray-800 text-black bg-blue-500 text-white flex items-center justify-center font-medium cursor-pointer">Created Ago</div>
            </div>
            {{--/AGO--}}
        </div>
        {{--  /ROW  --}}
